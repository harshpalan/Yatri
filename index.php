	...
	<div class="wrap">
		...
		<div class="navbar navbar-inverse">
			<div class="navbar-inner">
				...
				if(isset($_SESSION['name']))
				{
				 ...
				 ?>
				<!-- 
				<a href="login1.php" class="btn btn-info" style="float:right;">Login</a>&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="signup.php?value=0" class="btn btn-info" style="float:right;margin-right: 15px">Signup</a>
				 --><!-- <a class="brand" href="profile.php"  style="float:right;">PROFILE</a> -->
				</div>
			</div>
		</div>
		<div class="span12 well">
			...
			<div id="myCarousel" class="carousel slide" style="width:600px; float:left;margin-bottom:3px;">		
				...
				<div class="active item"><img src="images/t2.jpg" style="width:600px;height:350px;"/></div>
				<div class="item"><img src="images/t1.jpg" style="width:600px;height:350px;"/> </div>
				<div class="item"><img src="images/t3.jpg" style="width:600px;height:350px;"/></div>
				<div class="item"><img src="images/t4.jpg" style="width:600px;height:350px;"/></div>
				<div class="item"><img src="images/t5.jpg" style="width:600px;height:350px;"/> </div>
<!-- 				<div class="item"><img src="images/.png"style="width:600px;height:350px;"/></div>
 -->				
				</div>
			...
			<marquee behavior="scroll" id="marq"  scrollamount=3 direction="up" height="294px" onmouseover="nestop()" onmouseout="nestrt()">
				<div>
				<p style="color:#f21f1f;">-------------------------NEWS--------------------------</h1><br> 
