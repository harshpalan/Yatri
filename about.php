				...
				<div >
					<div  style="margin-left:100px; ">
						<table style="padding:5px;">
							<tr> 
								<td > Name &nbsp; </td>
								<td style="font-family:Kristen ITC;"> : Harsh Palan</td>
							</tr>
							<tr>
								<td > Profession &nbsp; </td>
								<td style="font-family:Kristen ITC;"> : B.Tech. Computer Engineering ** </td>
							</tr>
							<tr>
								<td > University &nbsp; </td>
								<td style="font-family:Kristen ITC;"> : K.J.Somaiya College of Engineering</td>
							</tr>
						...
						<div style="margin-top:20px;">
							...
							Follow Us On &nbsp;  
							<a href="https://www.linkedin.com/in/harsh-palan-b58680143/" target="_blank"><img src="images/in.png"/></a>
						</div>
					</div>
				</div>
			</div>
			...
			<div style="margin-left:195px; float:right;" >
				...
				<div class="about-detail" style="margin-left:110px; margin-top:15px;">
					<table style="padding:5px;">
						<tr> 
							<td> Name &nbsp; </td>
							<td style="font-family:Kristen ITC;"> : Rishik Kabra</td>
						</tr>
						<tr>
							<td> Profession &nbsp; </td>
							<td style="font-family:Kristen ITC;"> : B.Tech. Computer Engineering ** </td>
					...
					<div style="margin-top:20px;">
					 	...
					 	Follow Us On &nbsp;  
						<a href="https://www.linkedin.com/in/rishik-kabra-5113b1160/" target="_blank"><img src="images/in.png"   /></a>
					</div>
